 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'git@github.com:smohadjer/solmazmohadjer.com.git');
...
define('TMP_DIR', '/var/www/vhosts/solmazmohadjer.com/tmp/spgd-'.md5(REMOTE_REPOSITORY).'/');
